...
export default function Direction() {
  return <div className="w-full flex flex-col justify-start items-center p-8 2xl:p-16 bg-gradient-to-t from-blue-950 to-black">
    <div className="flex flex-col gap-4 w-full items-center">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 w-full mt-16">
