...
export default function DirectionCard({ direction }: DirectionCardProps) {
  return (
    <>
        <div className="w-full h-full flex flex-col justify-start items-center p-8 bg-black/20 backdrop-blur-md rounded-xl hover:bg-black/50 transition-all duration-300 ease-in-out">
