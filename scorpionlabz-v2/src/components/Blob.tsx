...
const Blob = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      blob.position.x = 1.5 * blobScale + Math.sin(time * 0.3) * 0.2 * blobScale;
    ...
    const handleResize = () => {
      ...
      blob.position.x = 1.5 * newBlobScale; // Update position to match new scale
  ...
  return <div ref={mountRef} className="w-full h-full bg-transparent"></div>;
};
